...
namespace pgr::visualization
{
    ...
    static visualization_msgs::msg::Marker create_rviz_cone_visualization_message(const std::string &name_space, const pgr::cones::Cone &cone, const int marker_count)
    {
    ...
    [[deprecated("This is not recommended, please use ***_LIST for marker publishing")]]
    static visualization_msgs::msg::Marker create_rviz_line_visualization_message(const std::string &name_space, const pgr::cones::Cone &cone1, const pgr::cones::Cone &cone2, const size_t marker_id)
    {
    ...
    static visualization_msgs::msg::Marker create_circle(
        const float x,
        const float y,
        const float diameter,
        const std::string &frame_id,

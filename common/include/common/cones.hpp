...
namespace pgr::cones
{
    static void separate_cone_sides(const std::vector<Cone> &input_cone_array, ConeArray &inner_cone_array, ConeArray &outer_cone_array)
    {
    ...
    static bool check_pairs_equality(const ConePair &pair1, const ConePair &pair2)
    {

...
visualization_msgs::msg::Marker Cone::create_rviz_visualization_message(const std::string &name_space, const int marker_count) const
{
    ...
    switch (m_side)
    {
    case Cone::TrackSide::LEFT:
        marker.id = marker_count;
        break;
    case Cone::TrackSide::RIGHT:
    ...
    switch (m_color)
    {
    case Cone::Color::YELLOW:
        marker.color = ::YELLOW;
        break;
    case Cone::Color::BLUE:
        marker.color = ::BLUE;
        break;
    case Cone::Color::ORANGE:
        marker.color = ::ORANGE;
        break;
    default:
...
visualization_msgs::msg::Marker Cone::create_rviz_line_visualization_message(const std::string &name_space, const Cone &cone1, const Cone &cone2, const size_t marker_id)
{
    ...
    if (cone1.get_side() == Cone::TrackSide::LEFT && cone2.get_side() == Cone::TrackSide::LEFT)
    {
        marker_line.color = ::YELLOW;
    }
    else if (cone1.get_side() == Cone::TrackSide::RIGHT && cone2.get_side() == Cone::TrackSide::RIGHT)
    {
        marker_line.color = ::BLUE;
    }
    else
    {
        marker_line.color = ::RED;
    }
